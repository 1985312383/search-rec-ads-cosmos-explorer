...
* **体系化设计**：从基础概念到工程实践，覆盖搜索、推荐、广告三大领域的核心知识体系。
* **前沿视角**：结合 LLM 新范式，系统探讨 RAG、语义检索、Agentic Search 等技术如何影响搜广推。
...
**🎯 算法专家** - 资深算法工程师、技术专家  
想要了解LLM时代的新趋势和实践经验？这里会持续跟踪业界正在探索的技术方向！
...
*   **第二站：核心算法 (第2-4章)**
    ...
    *   **关键词**：`BM25` `LTR` `语义检索` `协同过滤` `DeepFM` `CTR/CVR预估` `智能出价`
...
作者在业余时间持续更新，部分章节仍会继续校正、补充案例和完善公式说明。**欢迎通过 Star ⭐ 关注项目进展，你的关注是作者持续创作的最大动力！**
...
| `v0.3.x` | ✅ | 第二章：搜索算法 | 经典召回、LTR、查询理解、现代搜索技术已成体系 |
| `v0.4.x` | ✅ | 第四章：计算广告 | 生态、检索定向、预估、竞价、预算、归因、创意与风控已补齐 |
| `v0.5.x` | 🚧 | 第五章：高阶心法 | Tricks、负采样、校准、多任务、因果推断等持续校正 |
| `v0.6.x` | 🚧 | 第六章：LLM新范式 | LLM时代下的搜广推新范式持续完善 |
...
1. ✅ **第三章** 推荐算法（已完成）
2. ✅ **第一章** 评价驱动开发（已完成）
3. ✅ **第二章** 搜索算法（已完成一轮内容校正）
4. ✅ **第四章** 计算广告（目录扩展与主体内容已补齐）
5. 🚧 **第五至六章** 高阶方法与 LLM 新范式（持续校正）
6. 📋 **第七章** 动手实战（规划中）
