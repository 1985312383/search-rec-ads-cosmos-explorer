...
📖 **延伸阅读**
1. [Matrix Factorization Techniques for Recommender Systems](https://datajobs.com/data-science-repo/Recommender-Systems-[Netflix].pdf) - Koren等人的矩阵分解经典综述，结合了Netflix Prize经验总结
...
5. [Surprise Documentation](https://surprise.readthedocs.io/en/stable/) - 易于使用的Python矩阵分解库，适合快速实验
